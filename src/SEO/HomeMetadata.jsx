...
export default function HomeMetadata() {
    return (
        <Helmet>
            {/* SEO Meta Tags */}
            <title>
                EstateVision - 3D Модели, Статична Фотография и Дрон Изображения
                за Недвижими Имоти
            </title>
            <meta
                name="description"
                content="Открийте професионалните услуги на EstateVision: 3D модели на имоти, висококачествена статична фотография и зашеметяващи дрон изображения за недвижими имоти и архитектура."
            />
            <meta
                name="keywords"
