    ...
    return (
        <div>
            <Helmet>
                ...
                <meta
                    name="description"
                    content="Научете повече за мисията на EstateVision да революционизира визуализацията на имоти с 3D модели, фотография и дрон изображения. Открийте нашата история, ценности и опит."
                />
                <meta
                    name="keywords"
