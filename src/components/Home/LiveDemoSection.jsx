    ...
    return (
        <>
            <section className="w-full h-max overflow-hidden flex flex-col items-center bg-gradient-to-b from-dark-500 to-dark-600">
                {/* <div className="px-8 lg:px-0 w-full h-max flex justify-center">
                    <div className="mt-10 sm:mt-14 w-full lg:w-[850px] h-1 bg-yellow-400"></div>
                </div> */}
                ...
                <p className="text-gray-500 text-sm sm:text-lg lg:text-xl mt-2 max-w-full sm:max-w-2xl text-center px-2 sm:px-0">Без повече посещения, спечелете доверието на хората. Откроете се от останалите.</p>
