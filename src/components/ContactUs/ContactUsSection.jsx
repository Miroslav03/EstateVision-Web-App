...
export default function AboutUsSection() {
    ...
    return (
        <motion.section
            initial="hidden"
            animate="visible"
            className="w-full min-h-screen bg-gradient-to-r from-dark-700 to-dark-500 flex flex-col items-center gap-24 justify-center pt-24 sm:pt-52 pb-16 sm:pb-32"
        >
