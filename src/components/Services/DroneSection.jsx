...
import DroneServiceMetadata from "../../SEO/DroneServiceMetadata";
                ...
                <section className="w-full max-w-[90%] lg:max-w-[90%] flex flex-col lg:flex-row items-center gap-16 mb-6">
                    ...
                    >
                        <p className="text-gray-500 text-md sm:text-xl mb-6 max-w-lg">
                            С услугата за заснемане с дрон от EstateVision ще
                            видите света от нова височина! Нашите професионални
                            дронови кадри ще ви помогнат да уловите впечатляващи
                            въздушни снимки и видеа с високо качество, които ще
                            придадат уникален и динамичен изглед на всяко
                            пространство – било то природни ландшафти, събития,
                            строителни проекти или други специални моменти.
                        </p>
                        <p className="text-gray-500 text-md sm:text-xl mb-6 max-w-lg">
                            Дроновите технологии предоставят възможност за
                            заснемане на места и перспективи, които не могат да
                            бъдат достигнати по друг начин. Със стабилни и
                            детайлни кадри, нашите услуги ще преобразят вашето
                            визуално съдържание, като добавят дълбочина и мащаб,
                            които обикновената камера не може да улови.
                        </p>
                        <p className="text-gray-500 text-md sm:text-xl mb-6 max-w-lg">
                            Независимо от целта – било за документиране,
                            презентация или просто за споделяне на красотата
                            около вас – EstateVision е вашият партньор за
                            професионално заснемане с дрон. Свържете се с нас и
                            се уверете, че вашето съдържание ще бъде наистина
                            изключително!
                        </p>
                        <Link
